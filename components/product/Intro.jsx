    ...
    <div className="relative">
      <section className="z-1 flex flex-col items-center">
        <div className="mt-[182px] flex flex-col items-center">
          <h1 className="text-[36px] lg:text-[80px] font-bold leading-120% tracking-[-2%] bg-gradient-to-r from-[#000000] to-[#B3C0DF] text-transparent bg-clip-text">
            {t("title")}
          </h1>
        ...
        <Image
          className="mask-b-from-20% mask-b-to-110% max-w-[75vw] mt-10"
