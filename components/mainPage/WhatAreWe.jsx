...
export default function WhatAreWe() {
  ...
  return (
    <>
      <section className="font-Figtree flex flex-col items-left justify-center px-10 xl:px-60  md:mt-6">
        ...
        <p className="text-black md:text-3xl xl:text-4xl text-3xl max-sm:text-2xl max-sm:text-center font-semibold mt-10 md:mt-10">
          ...
          <span className="text-[#42B6B1] font-bold">
            {t("highlightedText.highlight")}
          </span>
