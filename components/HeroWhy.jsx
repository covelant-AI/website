    ...
    <section className="relative w-full overflow-hidden flex justify-center items-center">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 flex flex-col md:flex-row items-center justify-between min-h-screen mt-20 md:mt-0">
        ...
        <div className="max-w-2xl w-full text-left md:w-3/5 md:text-left text-center max-md:mt-60">
          <h1 className="sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-Figtree font-normal text-black leading-snug mb-8">
            Scale influencer ads effortlessly.<br /> Cut costs.<br /> Boost performance.
          </h1>
          <Link href="/contact">
        ...
        <div className="relative w-full md:w-[65%] lg:w-[60%] md:absolute md:right-[-20%] max-md:scale-[1.2] max-sm:bottom-20 ">
          <Image
