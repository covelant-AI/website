...
export default function NavigationBar() {
  ...
  return (
    <nav
      className="fixed top-0 left-0 w-full z-50 px-6 lg:px-12 py-2 flex items-center justify-between 
    ...
    >
      ...
      <div className="hidden lg:flex items-center space-x-8 text-lg font-medium text-black relative">
        <Link href="/product" className="hover:text-[#42B6B1] transition">
          Products
        </Link>
        <Link href="/About-Us" className="hover:text-[#42B6B1] transition">
          About Us
        </Link>
        <Link href="/faq" className="hover:text-[#42B6B1] transition">
          FAQ
        </Link>
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-6 text-lg font-medium text-black mt-10">
          <Link
            href="/product"
            className="hover:text-[#42B6B1] transition"
            onClick={() => setIsOpen(false)}
          >
            Products
          </Link>
