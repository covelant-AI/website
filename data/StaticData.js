...
export const pricingData = [
  {
    ...
    period: "",
    description: [
      "2 match analysis/month",
      "Single-player analytics dashboards",
      "Player-Coach Collaboration toolkit",
    ],
  },
  {
    title: "Athlete Plan",
  ...
  },
  {
    ...
    highlight: ["All Pro features", "Full AI Support","Full collaboration suite","Full Access to new feature rollouts","Faster Analysis", "Event invites",],
  },
    {
    title: "Elite Plan",
    monthlyPrice: "59.99€",
    ...
    description: [
      ...
      "Full Access to new feature rollouts",
      "Opponent AI analysis",
      "Event invites",
    ],
    highlight: ["All Pro features", "Full AI Support","Unlimited AI Support","Full Access to new feature rollouts","Opponent AI analysis","Event invites", "Unlimited Connections", "Unlimited Connections"],
  },
]
